...
public abstract class BaseQuickAdapter<T> extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    /**
     * when adapter's results size than pageSize and enable is true,the loading more function is enable,or disable
     *
     * @param pageSize
     * @param enable
     */
     ...
     * enable the loading more results function if enable's value is true,or disable
     *
     * @param enable
     */
    ...
    /**
     * setting up the size to decide the loading more results funcation whether enable
     * enable if the results size than pageSize,or diable
     *
     * @param pageSize
     */
    ...
    /**
     * setting up a new instance to results;
     *
     * @param data
     */
    ...
    /**
     * Get the results item associated with the specified position in the results set.
     *
     * @param position Position of the item whose results we want within the adapter's
     *                 results set.
     * @return The results at the specified position.
     */
     ...
     *
     * @param position The position of the item within the adapter's results set whose view type we
     *                 want.
    ...
    public int getItemViewType(int position) {
        ...
        /**
         * if user has no results and add emptyView and position <2{(headview +emptyView)}
         */
    ...
    /**
     * @param isHeadAndEmpty false will not show headView if the results is empty true will show emptyView and headView
     * @param emptyView
     */
     ...
     * that no results is available in this AdapterView.
     *
     ...
     *                   if true when loading more results can show loadingView
     */
     ...
     *
     * @param firstOnly true just show anim when first loading false show anim when load the results every time
     */
     ...
     *
     * @param position The position of the item within the adapter's results set whose row id we want.
