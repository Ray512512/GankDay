...
public static final int TYPE_DIS_LIKE=1;
    //分割线间距
    ...
    private int like = 30;
    private int disLike = 30; //点赞数,差评数
    ...
    private int type = TYPE_NONE; //选择执行帧动画的笑脸 //0 笑脸 1 哭脸
    ...
    public void setLikeType(int type){
        disBack.setBackgroundResource(type==1?R.drawable.yellow_background:R.drawable.white_background);
        likeBack.setBackgroundResource(type==0?R.drawable.yellow_background:R.drawable.white_background);
    }
...
//        likeAll.addView(likeNum, params);
    ...
    public void setOnClickCallBack(SmileView.onClickCallBack onClickCallBack) {
    ...
    public void animBack() {
        ...
        animatorBack.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            ...
            public void onAnimationUpdate(ValueAnimator animation) {
                ...
                if (type==TYPE_LIKE&&magrin <= like * 4) {
                    imageLike.setLayoutParams(paramsLike);
                }
                if (type==TYPE_DIS_LIKE&&magrin <= disLike * 4) {
