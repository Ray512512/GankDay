...
public class MNImageBrowser {
    ...
    public MNImageBrowser setOnPageChangeListener(ViewPager.SimpleOnPageChangeListener onPageChangeListener) {
        imageBrowserConfig.setOnPageChangeListener(onPageChangeListener);
        return this;
    }

    public MNImageBrowser setTitle(String title){
        imageBrowserConfig.setTitle(title);
        return this;
    }

    public MNImageBrowser setGankData(ArrayList<Gank> gankData){
        imageBrowserConfig.setGanks(gankData);
        return this;
    }
